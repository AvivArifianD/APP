		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "e-Change Group",
									"targetURL": "#comzhrxchangegroupzhrxchangegroup-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzhrxchangegroupzhrxchangegroup-display": {
								"semanticObject": "comzhrxchangegroupzhrxchangegroup",
								"action": "display",
								"description": "e-Change Group",
								"title": "e-Change Group",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zhrxchangegroup.zhrxchangegroup",
									"url": sap.ui.require.toUrl("com/zhrxchangegroup/zhrxchangegroup")
								}
							}
						}
					}

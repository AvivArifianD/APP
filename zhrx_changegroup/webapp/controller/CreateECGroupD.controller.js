sap.ui.define([
    ...
    function (Controller, JSONModel, Fragment, Filter, FilterOperator, MessageBox, Dialog, Button, mobileLibrary, Text) {
        ...
        return Controller.extend("com.zhrxchangegroup.zhrxchangegroup.controller.CreateECGroupD", {
            onInit: function () {
            ...
            onValueHelpRequestPer: function (oEvent) {
                ...
                this._pValueHelpDialogPer.then(function (oDialog) {
                    var lvOrgeh = loView.oModels.headerArray.oData.Zzorgeh;
            ...
            _resetAll: function () {
                var loPernr = this.byId("id_Pernr"),
                    ...
                    loNotif1text = this.byId("id_notif1text"),
                    loNotif2text = this.byId("id_notif2text"),
                    loNotif3text = this.byId("id_notif3text"),
                ...
                loNotif1text.setText(null);
                loNotif2text.setText(null);
                loNotif3text.setText(null);
                        ...
                        this.oModel.create("/zhr_ecgroup_itemSet", lwEntry,
                            {
                                ...
                                error: function (e) {
                                    ...
                                    if (e.responseText) {
                                        var laErrorMessage = JSON.parse(e.responseText),
                                            lvErr = laErrorMessage.error.message.value;

                                        that.oErrorHandler.pushError(lvErr);
                                        that.oErrorHandler.displayErrorPopup();

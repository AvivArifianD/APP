sap.ui.define([
    ...
    function (Controller, Filter, FilterOperator, Fragment, Token) {
        ...
        return Controller.extend("com.zhrxchangeshift.zhrxchangeshift.controller.MainChgItem", {
            onInit: function () {
            ...
            handleValueHelpPer2: function (oEvent) {
                ...
                if (!this._pValueHelpDialogPer) {
                    this._pValueHelpDialogPer = Fragment.load({
                        id: oView.getId(),
                        name: "com.zhrxchangeshift.zhrxchangeshift.view.fragment.ValueHelpDialogPer2",
                        controller: this
                    }).then(function (oValueHelpDialog) {
                        oView.addDependent(oValueHelpDialog);
                        return oValueHelpDialog;

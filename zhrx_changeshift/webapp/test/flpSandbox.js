		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "e-Change Shift",
									"targetURL": "#comzhrxchangeshiftzhrxchangeshift-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzhrxchangeshiftzhrxchangeshift-display": {
								"semanticObject": "comzhrxchangeshiftzhrxchangeshift",
								"action": "display",
								"description": "e-Change Shift",
								"title": "e-Change Shift",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zhrxchangeshift.zhrxchangeshift",
									"url": sap.ui.require.toUrl("com/zhrxchangeshift/zhrxchangeshift")
								}
							}
						}
					}

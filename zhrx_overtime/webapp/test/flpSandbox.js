		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "e-Overtime",
									"targetURL": "#comzhrxovertimezhrxovertime-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzhrxovertimezhrxovertime-display": {
								"semanticObject": "comzhrxovertimezhrxovertime",
								"action": "display",
								"description": "e-Overtime",
								"title": "e-Overtime",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zhrxovertime.zhrxovertime",
									"url": sap.ui.require.toUrl("com/zhrxovertime/zhrxovertime")
								}
							}
						}
					}

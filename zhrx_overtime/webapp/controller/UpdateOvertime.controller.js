sap.ui.define([
    ...
    function (Controller, MessageToast, JSONModel, Fragment, Filter, FilterOperator, MessageBox, Dialog, Button, mobileLibrary, Text) {
        ...
        return Controller.extend("com.zhrxovertime.zhrxovertime.controller.UpdateOvertime", {
            onInit: function () {
            ...
            onValueHelpClosePer: function (oEvent) {
                ...
                var lvEdate = this.formatoDataString(this.getView().getModel("header").getData().Zzedate);
            ...
            onAdd: function () {
                if (!this.ovtValidation()) {
                    ...
                    var lvPernr = this.byId("id_Pernr").getValue(),
                        ...
                        lvEdate = this.getView().getModel("header").getData().Zzedate,
            ...
            onSubmit: function (oEvent) {
                var oListModel = this.byId("id_splRequestTable").getModel("ovtList"),
                    ...
                    oZzorgeh = this.getView().getModel("header").getData().Zzorgeh,
                    oZzedate = this.getView().getModel("header").getData().Zzedate,
                ...
                var oModel = new JSONModel({
                    ...
                    Zzedate: this.getView().getModel("header").getData().Zzedate,
                    Zzpersa: this.getView().getModel("header").getData().Zzpersa,
                    Zzbtrtl: this.getView().getModel("header").getData().Zzbtrtl,
                    Zzottyp: this.getView().getModel("header").getData().Zzottyp,
                    ZzottypTxt: this.getView().getModel("header").getData().ZzottypTxt,
                ...
                if (typeof oListDataAttach !== "undefined") {
                    for (var i = 0; i < oListDataAttach.length; i++) {
                        var ovtItemA = {
                            Zzdocid: this.getView().getModel("header").getData().Zzdocid,
                            Fileid: oListDataAttach[i].Fileid,

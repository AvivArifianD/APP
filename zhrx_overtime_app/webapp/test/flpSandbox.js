		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Approval e-Overtime",
									"targetURL": "#comzhrxovertimeappzhrxovertimeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzhrxovertimeappzhrxovertimeapp-display": {
								"semanticObject": "comzhrxovertimeappzhrxovertimeapp",
								"action": "display",
								"description": "Approval e-Overtime",
								"title": "Approval e-Overtime",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zhrxovertimeapp.zhrxovertimeapp",
									"url": sap.ui.require.toUrl("com/zhrxovertimeapp/zhrxovertimeapp")
								}
							}
						}
					}
